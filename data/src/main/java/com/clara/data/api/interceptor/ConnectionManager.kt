 ...
 *
 * It uses Android's [android.net.ConnectivityManager] and [android.net.NetworkCapabilities] to perform the check.
 *
 * @constructor Creates an instance with an application context injected by Hilt.
 *
 * @param context The application context used to access the system [android.net.ConnectivityManager].
 */
